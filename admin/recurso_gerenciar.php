...
// Verifica se está editando um recurso
if ($_GET['action'] === 'editar') {
	...
	$sql = "UPDATE recurso_gerenciar SET rec_assunto = :rec_assunto, rec_descricao = :rec_descricao, rec_status = :rec_status WHERE rec_id = :rec_id";
