...
if ($pagina === 'cadastro_tipos_docs') {
	...
	<div class='centro'>
		...
		<div id='botoes'><input value='Novo Documento' type='button' onclick=\"window.location.href='cadastro_tipos_docs.php?pagina=adicionar_cadastro_tipos_docs$autenticacao';\" /></div>
	";
