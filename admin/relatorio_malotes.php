...
function montarFiltros(&$parametros)
{
    ...
    if ($baixado === '1') {
        ...
        $filtros[] = "(mai_baixado IS NULL OR mai_baixado = 0)";
    }
    ...
    return $filtros ? implode(' AND ', $filtros) : '1=1';
}
...
$sql = "
    SELECT DISTINCT malote_gerenciar.*, cadastro_clientes.cli_nome_razao
    FROM malote_gerenciar
    LEFT JOIN cadastro_clientes ON cadastro_clientes.cli_id = malote_gerenciar.mal_cliente
    LEFT JOIN malote_itens ON malote_itens.mai_malote = malote_gerenciar.mal_id
    WHERE $filtros_sql
...
$page = "Relatórios &raquo; <a href='relatorio_malotes.php?pagina=relatorio_malotes'>Malotes</a>";
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <div class='centro'>
            ...
            <div class='filtro'>
                <form name='form_filtro' id='form_filtro' enctype='multipart/form-data' method='get'
                    action='relatorio_malotes.php?pagina=relatorio_malotes'>
            ...
            <div class='contentPrint' id='imprimir'>
                ...
                <table align='center' width='100%' border='0' cellspacing='0' cellpadding='10' class='bordatabela'>
                    ...
                    foreach ($malotes as $malote):
                        ...
                        $cli_nome_razao = $malote['cli_nome_razao'] ?? '';
                ...
                <?php else: ?>
                <br><br><br>Não há malotes para os filtros selecionados.
                <?php endif; ?>
