...
// Função para obter o nome da periodicidade
...
// Ajuste para LIMIT/OFFSET (bindValue por ser inteiro)
...
<body>
	...
	$pageTitulo = "Relatórios &raquo; <a href='relatorio_documentos.php?pagina=relatorio_documentos$autenticacao'>Documentos</a>";
	?>

	<div class='centro'>
		<div class='titulo'><?= $pageTitulo ?></div>
		<div class='filtro'>
			<form name='form_filtro' id='form_filtro' enctype='multipart/form-data' method='post'
				...
				<select name='fil_tipo_documento' id='fil_tipo_documento'>
					<option value='<?= $tipoDocumento ?>'><?= $nomeTipoDocumento ?></option>
					<?php
				...
				<input name='fil_nome' id='fil_nome' value='<?= $nomeCliente ?>' placeholder='Cliente'>
				<select name='fil_periodicidade' id='fil_periodicidade'>
					<option value='<?= $periodicidade ?>'><?= $nomePeriodicidade ?></option>
				...
				<input type='text' name='fil_data_inicio' id='fil_data_inicio' placeholder='Data Início'
					value='<?= $dataInicio ?>' onkeypress='return mascaraData(this,event);'>
				<input type='text' name='fil_data_fim' id='fil_data_fim' placeholder='Data Fim' value='<?= $dataFim ?>'
					onkeypress='return mascaraData(this,event);'>
				<select name='fil_vencido' id='fil_vencido' style='width:150px;'>
					<option value='<?= $vencido ?>'><?= $nomeVencido ?></option>
				...
				<table align='center' width='100%' border='0' cellspacing='0' cellpadding='10' class='bordatabela'>
					...
					foreach ($documentos as $doc):
						...
						<tr class='<?= $classeLinha ?>'>
							<td><?= $doc['tpd_nome'] ?? '' ?></td>
							<td><?= $doc['cli_nome_razao'] ?? '' ?></td>
							<td><?= $doc['doc_id'] ?> (<?= $doc['tps_nome'] ?? '' ?>)</td>
