...
if($rowsprocura>0)
{
	...
	{
		echo "<input id='campo' value='&raquo; ".$rowsprocura['cli_nome_razao']." (".$rowsprocura['cli_cnpj'].")' name='campo' onclick='carregaClientePrestacao(this.value,\"".$rowsprocura['cli_id']."\");'><br>";
	}
