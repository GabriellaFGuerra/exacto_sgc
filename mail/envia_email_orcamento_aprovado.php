...
$not_nome = "Orçamento Aprovado";
$not_obs = "
            <p>
            <b>N° Orçamento:</b> $orc_id<br>
			<b>Data de aprovação:</b> ".implode("/",array_reverse(explode("-",$orc_data_aprovacao)))."<br>
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->Subject  = "".utf8_decode("Orçamento Aprovado").""; // Assunto da mensagem
