...
.containermenu				{ margin:0 auto;width:100%;background:#<?php echo $ger_cor_primaria; ?>;height:46px;text-align:center;border:none; vertical-align:middle;}
.textomenu					{ margin:0 auto;padding:0;width:1160px;height:46px;text-align:center;}
...
.menu li.top 				{ display:block; float:left; text-align:left; border: none; border-right:1px solid #CCC; padding:0;}
...
.menu li a.top_link 		{ display:block; float:left; height:46px; line-height:46px; color:#FFF; text-decoration:none; padding:0; cursor:pointer; padding:0 25px;  -webkit-transition-duration: 0.5s;-moz-transition-duration: 0.5s;transition-duration: 0.5s;}
...
.menu li:hover > a.top_link { color:#FFF; padding:0 25px;}
